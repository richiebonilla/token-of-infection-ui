...
var widgetUrl = 'https://widget.portis.io';
var supportedScopes = ['email', 'reputation'];
var Portis = /** @class */ (function () {
    ...
    Portis.prototype.getExtendedPublicKey = function (path) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        widgetCommunication = (_a.sent()).communication;
                        return [2 /*return*/, widgetCommunication.getExtendedPublicKey(path, this.config)];
                }
            });
        });
    };
    ...
    Portis.prototype._valiadateParams = function (dappId, network, options) {
        ...
        if (options.scope) {
            ...
            var unknownScope = options.scope.filter(function (item) { return supportedScopes.indexOf(item) < 0; });
